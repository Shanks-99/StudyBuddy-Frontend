...
const ActiveStudyRoom = () => {
    ...
    useEffect(() => {
        ...
        if (!navigator.mediaDevices) {
            console.warn("MediaDevices API not available (likely due to insecure HTTP context).");
            // Jump straight to the catch block for fallback text-only mode
            handleMediaError(new Error("MediaDevices API not available"));
            return;
        }
