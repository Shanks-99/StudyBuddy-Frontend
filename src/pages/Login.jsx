...
import { LogIn, Mail, Lock, AlertCircle, Sparkles, ArrowLeft, ShieldCheck, RefreshCw, Eye, EyeOff } from 'lucide-react';
...
const Login = () => {
    ...
    return (
        <main className="relative min-h-screen bg-slate-50 dark:bg-[#0a0a0f] text-slate-900 dark:text-white flex items-start justify-center px-6 pt-12 md:pt-24 overflow-hidden font-sans transition-colors duration-300">
                ...
                >
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="relative group">
                            <Mail className="absolute left-4 top-[38px] text-slate-400 dark:text-gray-400 w-5 h-5 z-10" strokeWidth={2} />
                            <Input
                                label="Email Address"
                                type="email"
                                name="email"
                        ...
                        <div className="relative group">
                            <Lock className="absolute left-4 top-[38px] text-slate-400 dark:text-gray-400 w-5 h-5 z-10" strokeWidth={2} />
                            <Input
                                label="Password"
                            ...
                            <button
                                ...
                                className="absolute right-4 top-[38px] text-slate-400 dark:text-gray-400 hover:text-purple-600 dark:hover:text-white transition-colors z-20"
                            >
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 rounded-2xl border border-slate-200 dark:border-white/10 px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                            disabled={isLoading}
                        >
